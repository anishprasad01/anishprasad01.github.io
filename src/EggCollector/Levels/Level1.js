...
Level1.prototype.initialize = function () {
    ...
    this.mEnemyOne = new EnemyBird(this.kBirdTexture, this.mBird, [-50, 0], [35, 35]);
    ...
    this.mEnemyTwo = new EnemyBird(this.kBirdTexture, this.mBird, [50, 55], [30, 30]);
    //this.mTestEnemy.setDrawRigidShape(true);
    ...
    this.mEnemyThree = new EnemyBird(this.kBirdTexture, this.mBird, [-45, 90], [40, 30]);
    //this.mTestEnemy.setDrawRigidShape(true);
